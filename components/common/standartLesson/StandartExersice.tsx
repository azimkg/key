...
const letters = ['sadasada', 'asdasda', 'asdada', 'asdadsas', 'asdasaff', 'fghfg'];
          ...
          return (
            <div key={lineIndex} className={classes(cls.line)} >
                ...
                return (
                  <div
                    ...
                    className={classes(
                      ...
                      { [cls.border]: currentIndex === cumulativeIndex - 1 },
                    )}
                  >
                    <p>{letter}</p>
                  </div>
              ...
              {lineIndex !== letters.length - 1 && (
                <>
                  <Enter key={`icon_${iconIndex}`} className={classes({ [cls.icon]: currentIndex < cumulativeIndex + 1 })} />
