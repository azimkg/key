  ...
  return (
    <div className={cls.template}>
      ...
      <div className={cls.actions}>
        <Button white onClick={handleClose} height={ButtonHeight.M}>{t('button.cancel')}</Button>
        <Button onClick={handleChangeCourse} height={ButtonHeight.M}>{t('button.apply')}</Button>
      </div>
    </div>
  );
};
